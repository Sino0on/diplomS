    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shop_name', models.CharField(blank=True, max_length=123, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('is_shop', models.BooleanField(blank=True, default=False)),
                ('image', models.ImageField(blank=True, null=True, upload_to='avatars/%Y/%m/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.pricehistory')),
                ('shop', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='ProdImgs',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('price', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.pricehistory')),
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='orders', to='app.product')),
            ],
        ),
        migrations.AddField(
            model_name='shop',
